...
class logmuter {
    ...
    public function __construct() {
        ...
        /*
         * If this is the first object to be instantiated then store away the previous configuration
         * settings to allow us to restore them on unmute.
         */
        if (self::$oldsettings === null) {
            if (array_key_exists('tool_log', $CFG->forced_plugin_settings)) {
                self::$oldsettings = $CFG->forced_plugin_settings['tool_log'];
            } else {
                self::$oldsettings = array();
            }
        }
    }
