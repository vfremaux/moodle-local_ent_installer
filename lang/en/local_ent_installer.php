...
$string['configroleassigncontextattribute_desc'] = 'LDAP attribute for the role assignment target context key. This may be any value of one of the possible identifying fields.';
...
$string['configroleassigncoursecatkey_desc'] = 'Moodle field for finding course categories. This may be any value of one of the possible identifying fields.';
$string['configroleassigncoursekey'] = 'Course key';
$string['configroleassigncoursekey_desc'] = 'Moodle field for finding a course. This may be any value of one of the possible identifying fields.';
$string['configroleassignmodulekey'] = 'Course module key';
$string['configroleassignmodulekey_desc'] = 'Moodle field for finding a course module. This may be any value of one of the possible identifying fields.';
$string['configroleassignblockkey'] = 'Block key';
$string['configroleassignblockkey_desc'] = 'Moodle field for finding a block. This may be any value of one of the possible identifying fields.';
$string['configroleassigntargetuserkey'] = 'Target user key';
$string['configroleassigntargetuserkey_desc'] = 'Moodle field for finding the target user context. This may be any value of one of the possible identifying fields.';
$string['configroleassignuserkey'] = 'Role assignment user key';
