...
require_once($CFG->dirroot.'/local/ent_installer/lib.php'); // to get xx_supports_feature();
if ('pro' == local_ent_installer_supports_feature()) {
    include($CFG->dirroot.'/local/ent_installer/pro/lang/fr/pro.php');
}
